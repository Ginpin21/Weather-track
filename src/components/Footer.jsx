...
const Footer = () => {
  return (
    <footer className=" sticky bottom-0 z-10 flex flex-col items-center p-1 text-xl font-extralight bg-white shadow-slate-500 dark:bg-slate-800 dark:text-slate-200 dark:shadow-slate-200  shadow-inner">
